...
[root@front_251 shell_03]# echo "scale=2;141*100/7966"|bc
 1.77
[root@front_251 shell_03]# echo "`echo "scale=2;141*100/7966"|bc`%" 1.77%
[root@front_251shell_03]#echo"当前内存使用率：echo"scale=2;141*100/7966"|bc%" 当前内存使用率：1.77%
［root@front_251shell_o3]#
###  脚本退出
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODYyMjg2MDcyLC01OTA0NTU2NzAsMTQ2MT
