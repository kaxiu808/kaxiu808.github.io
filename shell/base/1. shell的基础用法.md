...
[root@baism~]# expr 1 +1 2
[root@baism~]#expr5-2 3
否则认为是通配符
[root@baism~]#expr5\*2
#注意*出现应该转义，
1e
[root@baism~]#expr5/2 2
[root@baism~]#expr5%2 1
使用bc计算器处理浮点运算，Scale=2代表小数点保留两位
[root@baism~]#echo"scale=2;3+1oo"|bc 103
[root@baism ~]#echo"scale=2;1oo-3"|bc 97
[root@baism~]#echo"scale=2;1ee/3"|bc 33.33
[
```
###  脚本退出
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIyMjc3MzE3OCwxNDYxNzczOTI3LDExNT
I3NDkwNTIsLTE1NzE5NzUzMjAsLTEzNDI3Njg1MzMsMTYxMzA0
NzkxNyw3NjY3MDExOTAsMTgyOTU3NDgxOCwxNjAyMDkxMDcwLD
E2NjEzMDc3MjYsNTY3MjA1MDU5LDE4MTE5Mjc4MDMsNzMyMDc4
NzY4LC03MDg3NjM1ODMsMTAwNjc1NjQ1LC0xMDYwMzE5NjU3XX
0=
-->