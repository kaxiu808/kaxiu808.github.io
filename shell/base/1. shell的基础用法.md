...
```shell
[root@front_251shell_03]#rm-rfnginx-1.16.0[root@front251shello3l#ls
nginx-1.16.0.tar.gznginx_install.sh
[root@front_251shell_03]#llnginx_install.sh
rw-r--r-
1rootroot6525月
7o5:o2nginx_install.sh
[root@front_251shell_03]#bashnginx_install.sh hello world!
[root@front_251 shell_03]# shnginx_install.sh hello world!
[root@front_251shell_03]#cat/etc/shells/bin/sh
/bin/bash
/sbin/nologin/usr/bin/sh
/usr/bin/bash
/usr/sbin/nologin
[root@front_251shell_03]#bash nginx_install.sh helloworld!
[root@front 251 shell 03]# sh nginx install.sh hello world!
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAwNjU3MjU1LDE2MDIwOTEwNzAsMTY2MT
MwNzcyNiw1NjcyMDUwNTksMTgxMTkyNzgwMyw3MzIwNzg3Njgs
LTcwODc2MzU4MywxMDA2NzU2NDUsLTEwNjAzMTk2NTddfQ==
-->