...
* [认识python语言](python/)
   ...
   - [3.mysql数据库操作](/python/base/mysql数据库操作.md)
   - [4.分组&连表查询](/python/base/分组&连表查询.md)
   - [5.pymysql操作](/python/base/pymysql操作.md)
...
* [与shell命令脚本的偶遇](shell/)
	 ...
	 - 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MzExMDI2ODcsMjEyNDcxOTY3NCwxMz
A3MTI2NTYxXX0=
-->