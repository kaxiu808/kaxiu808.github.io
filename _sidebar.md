...
* [认识python语言](python/)
   ...
   - [3.mysql数据库操作](/python/base/3.mysql数据库操作.md)
   - [4.分组&连表查询](/python/base/4.分组&连表查询.md)
   - [5.pymysql操作](/python/base/5.pymysql操作.md)
...
* [与shell命令脚本的偶遇](shell/)
	 ...
	 - 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI1MTQxODYyOSwyMTI0NzE5Njc0LDEzMD
cxMjY1NjFdfQ==
-->