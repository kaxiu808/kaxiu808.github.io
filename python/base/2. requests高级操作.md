...
# 使用session对象进行请求发送：如果该次请求时，服务器端给客户端创建cookie的话，则该cookie就
```



<!--stackedit_data:
eyJoaXN0b3J5IjpbNjA0MjA5OTE0LDE0ODQyNzEyNjcsMzI2MT
E5NDQ1LC03ODI0OTQ3NTIsLTEyNjQ4ODY4NTAsMTk4OTUwMTM1
Nyw4ODgwMTMzMjcsNDQwOTA1NjE5XX0=
-->