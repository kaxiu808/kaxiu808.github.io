...
浏览器的上下文管理对象Context可以用于管理Context打开/创建的多个page页面。并且可以创建多个Context对象，那么不同的Context对象打开/创建的page之间是相互隔离的（每个Context上下文都有自己的Cookie、浏览器存储和浏览历史记录）。
 ...
 - 打开百度的多个链接对应的page页面
![Context上下文](https://gitlab.com/minika1/Pic/-/raw/main/pictures/2024/04/6_14_30_55_context%E4%B8%8A%E4%B8%8B%E6%96%87.png)
kakaluote123
...
![Snip20231226_25](https://pan.baidu.com/s/imgs/Snip20231226_25.png)

-   添加环境变量

![Snip20231226_26](https://pan.baidu.com/s/imgs/Snip20231226_26.png)
...
-   执行后会启动chrome浏览器
    -   可以在浏览器中手动访问百度。
-   在你已经打开的浏览器页面，手工操作登录，登录成功后，让playwright继续操作。
-   Playwright接管浏览器
...
![Snip20231226_27](https://pan.baidu.com/s/imgs/Snip20231226_27.png)

![Snip20231226_28](https://pan.baidu.com/s/imgs/Snip20231226_28.png)
...
![Snip20231227_35](https://pan.baidu.com/s/imgs/Snip20231227_35.png)
...
-   分析：
    ...
    -   在首页滑动滚轮会有新数据加载出来，因此分析出，我们要爬取的数据是通过ajax请求返回的。因此在抓包工具中重点监测XHR中的ajax请求数据包，最终定位到：
        ...
        -   Homefeed数据包
            ...
            -   请求方式：POST
            -   网址 ： https://edith.xiaohongshu.com/api/sns/web/v1/homefeed
    -   使用postman验证homefeed数据包的请求头和cookie
        
        -   复制homefeed的cURL（完整的请求信息）到postman中
        
        ![Snip20231227_36](https://pan.baidu.com/s/imgs/Snip20231227_36.png)
        
        ![Snip20231227_38](https://pan.baidu.com/s/imgs/Snip20231227_38.png)
    ...
    -   断点调试找寻x-s的生成方式：
        ...
        ![Snip20231227_39](https://pan.baidu.com/s/imgs/Snip20231227_39.png)
        
        -   此处打下断点，然后向下滑动滚轮，发起ajax请求，就会停留在该断点位置：
        
        ![Snip20231227_40](https://pan.baidu.com/s/imgs/Snip20231227_40.png)
        ...
        ![Snip20231227_41](https://pan.baidu.com/s/imgs/Snip20231227_41.png)
  ...
  -H 'cookie: abRequestId=6c868db0-4c88-567c-ae2b-6d9700b04d6f; xsecappid=xhs-pc-web; a1=18ec6e29727r5xzhbb3bmjnuunh30l6rd6njel7ej50000203779; webId=96462db842781e0fdac528c65f41c334; gid=yYdSKdJj0ifYyYdSKdJjWK1WJWF2CuxDDqD6IdVVI77IxV28q81KFd888J8qWWj84YDqifKy; webBuild=4.11.0; acw_tc=2a35c97622b7a2f11ba338f830f1875febe0fe90e8ec56fc369ebb9c6af911a3; websectiga=6169c1e84f393779a5f7de7303038f3b47a78e47be716e7bec57ccce17d45f99; sec_poison_id=e1dc7ee3-1d04-4bae-ae75-5ca3a52aef97; web_session=0400698fb4d46057a6b2223b23344be44494e2; unread={%22ub%22:%2265f421d300000000140040ac%22%2C%22ue%22:%2265f1bf8e0000000012032677%22%2C%22uc%22:19}' \
  ...
  -H 'x-b3-traceid: 812c7c2580904c5c' \
  -H 'x-s: XYW_' \
  -H 'x-s-common: ' \
  -H 'x-t: 1712747431211' \
  --data-raw '{"cursor_score":"","num":31,"refresh_type":1,"note_index":35,"unread_begin_note_id":"","unread_end_note_id":"","unread_note_count":0,"category":"homefeed_recommend","search_key":"","need_num":6,"image_formats":["jpg","webp","avif"],"need_filter_image":false}'
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU0NzgwNTI5NSwtMTI3Njk3Nzk5NCwtMz
Q4MjgyMDUsNTA4MjU4NTUzLDMyOTE4MjMxLDE1OTQ3NzU4NzEs
LTEyNzU1OTUwMTcsMzcyMTc3MzA4LC00MTk3MDg1NTVdfQ==
-->