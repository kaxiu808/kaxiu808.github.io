...
- 简单的分组查询
	- 注意：使用group by的查询字段必须是分组字段，否则会

 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3ODc0MDQzMTQsLTIxMzcyNjMwNDAsLT
...
LC0xNzAwNTkyNTg4LDE0ODg3MzU4NzMsLTE5MDAwODg1NSwzNj
EzNzAwODUsNjk3MzE1MTk5LC0zNjk5NDgzMTMsMjU3NzQ5MjA0
XX0=
-->