...
('张野','male',28,'20160311','operation',10000.13，4033），#以下是运营部门
...
```sql
createtabledep(
idintprimarykey, name char(20)
);
createtableemp(
idintprimarykey autoincrement name char(20),
sex enum("male","female")not null default"male",
age int, dep_idint
);
#插入数据
insertinto depvalues（200，技术，），
（201，人力资源，），（202，销售'），
（203，运营）；
insert intoemp(name,sex,age,depid)values
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ0MzU5MjU2NSwzNjIwNjQxMjMsNTQ5ND
g5Mjc2LDIxMDk1MDUwMzgsMTU3NzIzNjM5MCwtMTA0NzU5NDk4
OCwxNjg0Mjc3MDI3LC03NzMxMTkxNTQsLTIxMzcyNjMwNDAsLT
k2OTg1MDIyNiwzNTI1MDQ3MjUsLTEzMTk4MTYzOSwyOTI4OTg2
MjEsLTczNzM5NDA5LDE1NjgyMzMwMCwxNzIzNTY0MTI4LDEwNj
kyNjcxNzQsNDYzNTY2MTcsLTQ5OTk1OTQ3MiwtNDg3OTUyNDY1
XX0=
-->