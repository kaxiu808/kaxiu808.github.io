...
# 查询每个班级排名为前2的学生信息
select * from (
select *, dense_rank() over(partition by caption order by num desc) 排名 from student;

```

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMDA3NDYwODksMTAwNzUwNDA5MywxNz
MzNDI2OTYzLC0xMDUxNDA3NDMxLC0xNzk2MjA1NjI0LDExMjAx
NjQ4NDksMTUwNjAwOTI4NSw0NTc2MDI1MTksLTE3MTQ2MjEyNj
JdfQ==
-->