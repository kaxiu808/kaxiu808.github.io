...
# 查询每个班级排名为前2的学生信息
select *, dense_rank() over(partition by caption order by num desc) ba

```

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUyNzQ5OTE2NSwxMDA3NTA0MDkzLDE3Mz
M0MjY5NjMsLTEwNTE0MDc0MzEsLTE3OTYyMDU2MjQsMTEyMDE2
NDg0OSwxNTA2MDA5Mjg1LDQ1NzYwMjUxOSwtMTcxNDYyMTI2Ml
19
-->